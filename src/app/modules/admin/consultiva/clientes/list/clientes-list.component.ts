...
import { InventoryProduct, InventoryBrand, InventoryCategory, InventoryTag, InventoryPagination, InventoryVendor } from '../clientes.types';
...
export class ClientesLisComponent {
    ...
    this.searchInputControl.valueChanges
      .pipe(
        ...
        switchMap((query) => {
          this.closeDetails();
          this.isLoading = true;
          return this._clienteService.getProducts(0, 10, 'name', 'asc', query);
        }),
        map(() => {
    ...
    if (this._sort && this._paginator) {
      ...
      merge(this._sort.sortChange, this._paginator.page).pipe(
        switchMap(() => {
          this.closeDetails();
          this.isLoading = true;
          return this._clienteService.getProducts(this._paginator.pageIndex, this._paginator.pageSize, this._sort.active, this._sort.direction);
        }),
        map(() => {
          this.isLoading = false;
        }),
  ...
  toggleDetails(productId: string): void {
    ...
    this._clienteService.getProductById(productId)
      .subscribe((product) => {
  ...
  createTag(title: string): void {
    ...
    this._clienteService.createTag(tag)
      .subscribe((response) => {
  ...
  updateTagTitle(tag: InventoryTag, event): void {
    ...
    this._clienteService.updateTag(tag.id, tag)
  ...
  updateSelectedProduct(): void {
    ...
    this._clienteService.updateProduct(product.id, product).subscribe(() => {
